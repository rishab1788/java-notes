 ...
 */
public class a_overriding_method {

    //   here parent class has two method and the child class is also have method of one of the parent class method
    // which is redefine the method of parent class ..like bapp ko ladki passand h but beta apne man ki krna chata h
    // to method overrding krega  through inheritence
    ...
    //NOTE-OVERRIDING IS ONLY FOR METHOD NOT FOR DATAMEMEBERS;
